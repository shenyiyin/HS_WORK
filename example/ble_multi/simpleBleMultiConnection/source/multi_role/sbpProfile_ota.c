...
static uint8 simpleProfileChar5Props = GATT_PROP_READ |GATT_PROP_WRITE| GATT_PROP_NOTIFY; // to change to write only, HZF

// Characteristic 5 Value
static uint8 simpleProfileChar5[IBEACON_ATT_LONG_PKT];

// Simple Profile Characteristic 5 User Description
static uint8 simpleProfileChar5UserDesp[] = "NOTIFY\0";
...
const uint8_t water_ServiceUUID[ATT_UUID_SIZE] =
{0x12, 0x34, 0x56, 0x78, 0x90, 0x22, 0x42, 0x61, 0x91, 0x51, 0x8b, 0x9b, 0x03, 0xff, 0x33, 0x58};

//command characteristic
const uint8_t water_Temp_CharUUID[ATT_UUID_SIZE] =
{0x23, 0xf1, 0x6e, 0x53, 0xa4, 0x22, 0x42, 0x61, 0x91, 0x51, 0x8b, 0x9b, 0x02, 0xff, 0x33, 0x58};



static CONST gattAttrType_t water_Service = {ATT_UUID_SIZE, water_ServiceUUID};
...
//    },
    ...
    {                                                 
        { ATT_UUID_SIZE, water_Temp_CharUUID }, 
        GATT_PERMIT_READ|GATT_PERMIT_WRITE ,                            
        0,                                            
...
bStatus_t simpleProfile_Notify( uint8 param, uint8 len, void* value )
{
    ...
    case SIMPLEPROFILE_CHAR6:
        ...
        break;
		case SIMPLEPROFILE_CHAR5:
        notfEnable = GATTServApp_ReadCharCfg( 0, simpleProfileChar5Config );
        ...
        if ( notfEnable & GATT_CLIENT_CFG_NOTIFY )
        {
            ...
            //for SAR test copy the seqNum in pkt tail
            simpleProfileChar5[ATT_GetCurrentMTUSize(0)-4-1]=simpleProfileChar5[0];
            simpleProfileChar5[ATT_GetCurrentMTUSize(0)-3-1]=simpleProfileChar5[1];
            ret=GATTServApp_ProcessCharCfg( simpleProfileChar5Config, simpleProfileChar5, FALSE,
                                            simpleProfileAttrTbl, GATT_NUM_ATTRS( simpleProfileAttrTbl ),
                                            INVALID_TASK_ID );
        }
        else
