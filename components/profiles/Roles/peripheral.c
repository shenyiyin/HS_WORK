...
#include "gapbondmgr.h"
    ...
    #define DEF_GAPBOND_MGR_ENABLE 0
#endif
/*********************************************************************
    MACROS
*/
...
static uint8  gapRole_AdvertData1[B_MAX_ADV_LEN] =
{
...
static uint8  gapRole_AdvertData[B_MAX_ADV_LEN] =
{
    ...
    // length of the name (including the AD type byte)
    0x04,   
    ...
    // length of the device id (including the AD type byte)
    0x03,   
    ...
    // length of the water temperature data (including the AD type byte)
    0x03,   
    // AD type = Manufacturer specific data 
    GAP_ADTYPE_MANUFACTURER_SPECIFIC,   
